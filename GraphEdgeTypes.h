...
public:
	GraphEdge(): from_(invalid_node_index), to_(invalid_node_index), cost_(script->Get<float>("edge_defaultcost")){}
	GraphEdge(int from, int to) : from_(from), to_(to), cost_(script->Get<float>("edge_defaultcost")) {}
